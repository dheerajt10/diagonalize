...
As an example consumer of the app, we implemented a pseudonymous forum for people verified to be working at top tech companies, as well as a diagnostic healthcare tool that uses private inference. 
